...
/**
 * Class Appointment_Add_Controller.java handles the functionality of the
 * display for the add appointments window.
 */
public class Appointment_Add_Controller implements Initializable {
    ...
    /**
     * Initialize the controller class. Load data into ComboBoxes.
     */
    @Override
    ...
    void submitBtnPressed(ActionEvent event) throws IOException{
        ...
        AppointmentsDaoImpl.addAppointment(appointment);
